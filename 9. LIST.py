...
#nested lists:-
# A list can contain another list, this is called nested list.
matrix = [[1,2,3],[4,5,6],[7,8,9]]
print(matrix)
#example: print the matrix in a readable format.
for row in matrix:
    for col in row:
        print(col, end=" ")
    print()
#example: print the diagonal elements of the matrix.
for i in range(len(matrix)):
    print(matrix[i][i], end=" ")
#example: print the sum of diagonal elements of the matrix.
sum = 0
for i in range(len(matrix)):
    sum = sum + matrix[i][i]
print(sum)
#example: print the transpose of the matrix.
transpose = []
for i in range(len(matrix)):
    row = []
...
# Sum of numbers in list = 10 20 30 40 50 without using sum()?
...
# Find the Maximum and Minimum numbers from the list without using max() and min(),sort().
list1 = [5,6,4,8,9,2,33,3,7]
max1 = list1[0] #33
min1 = list1[0] #2
for num in numbers: # [5,6,4,8,9,2,33,3,7]
    if num > max1:
        max1 = num
    if num < min1:
        min1 = num
...
lis1 = ["Akshay","vishal","ram","kishore","rohith"]
lis2 = []
for x in lis1 :
 if "a" in x:
  lis2.append(x)
print(lis2)
searching_lis1 = input("enter the name to be found: ")
found = False
for i in lis1:
    if searching_lis1 == i:
        found = True
...
# Reserving a list without reverse:-
list1 = [5,6,4,8,9,2,33,3,7]
...
print(r_list)
 #(OR)#
 # By using reverse method we can "reserving a list without reverse method"
list1.reverse()
print(list1)

# Removing all negative numbers using loop:-
list1 = [-5,-6,-4,-8,-9,-2,-33,-3,-7,2,3,4,5,6,7,8,9]
positive_list = []
for i in range(len(numbers)):
    if numbers[i] > 0:
...
# Practise problems:-
#(1). Write a programme to find the average of all numbers in a list.
#(2). Count how many positive,negative and zero values are in a list.
#(3). Remove duplicate elements from a list.
#(4). Write a program to seperate even and odd numbers into two new lists.
